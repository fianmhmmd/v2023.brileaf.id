        ...
        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
            <div class="blog__details__content__wraper">
                <div class="blog__details__img" data-aos="fade-up">
                    <img src="https://brileaf.id/assets/galeri/gsb6.JPG" alt="blog">
                </div>
                <div class="blogarea__heading__2">
                        <h3>Cortesy Visit : Government Saving Bank Thailand</h3>
                    </div>
                <div class="blog__details__content">
                    <p class="content__1" data-aos="fade-up">On March 8th, 2023, BRI received a visit from the Government Saving Bank (GSB) of Thailand. There were 11 participants who attended this event. The visit was aimed at obtaining information on how BRI as a bank runs its business. The visit took place at the BRI head office building, Central Jakarta. The activity was carried out with remarks delivered by the President of BRI Research Institute, Mr. Anton Hendranata.</p>
                    <p class="content__2" data-aos="fade-up">The event began with an explanation about BRI Research Institute Company Profile by Ms. Miryati Safitri -BRI Research Institute and Credit Regulations in Indonesia by Mr. Roberto Akyuwen - OJK.</p>
                    <p class="content__3" data-aos="fade-up">There was also a presentation on Microbanking Overview, the Government's National Economic Recovery Program for Indonesian MSMEs, Ultra Micro and risk management. The activity lasted 8 hours and ended with a group photo of all participants at the BRI Research Institute.</p>
                    <div class="blog__details__img" data-aos="fade-up">
                    <img src="https://brileaf.id/assets/galeri/gsb1.JPG" alt="blog">
                </div>
                    ...
                    <div class="row blog__details__margin">
                        <div class="col-xl-4 col-lg-4 col-md-4" data-aos="fade-up">
                            <div class="blog__details__img__2">
                                <img src="<?= base_url('img/blog/blog_23.png');?>" alt="blog">
                                <div class="registerarea__content course__details__video">
                                    <div class="registerarea__video">
                                        <div class="video__pop__btn">
                                            <a class="video-btn" href="https://www.youtube.com/watch?v=vHdclsdkp28"> <img src="<?= base_url('img/icon/video.png');?>" alt=""></a>
                                        </div>
                    ...
                    <p class="content__8" data-aos="fade-up">We have covered many special events such as fireworks, fairs, parades, races, walks, awards ceremonies, fashion shows, sporting events, and even a memorial service.
                    </p>
                    <p class="content__9" data-aos="fade-up">
                        ...
                        sapien. Nulla quis diam sit amet turpis interdum accumsan quis nec enim. Vivamus faucibus ex sed nibh egestas elementum. Mauris et bibendum dui. Aenean consequat pulvinar luctus. Suspendisse consectetur tristique tortor
                    </p>
                ...
                <ul class="recent__list">
                    <li>
                        <div class="recent__img">
                            <a href="/news/uscmarshall">
                                <img src="<?= base_url('img/blog/blog_11.png');?>" alt="sidbar">
                        ...
                        <div class="recent__text">
                            ...
                            <div class="recent__date">
                                <a href="/news/uscmarshall">12 December 2022</a>
                            </div>

                            <h6><a href="/news/uscmarshall">Cortesy Visit: Ibear 45 from USC Marshall University, California, AS </a></h6>
                    ...
                    <li>
                        <div class="recent__img">
                            <a href="/news/aemfi">
                                <img src="<?= base_url('img/blog/blog_12.png');?>" alt="sidbar">
                                <div class="recent__number">
                                    <span>02</span>
                                </div>
                            </a>
                        ...
                        <div class="recent__text">
                            ...
                            <div class="recent__date">
                                <a href="/news/aemfi">23 December 2023</a>
                            </div>

                            <h6><a href="/news/aemfi">Brief Program (BRI International Delegation Forum): Delegation Of The ...</a></h6>
                    ...
                    <li>
                        <div class="recent__img">
                            <a href="/news/nepal">
                                <img src="<?= base_url('img/blog/blog_13.png');?>" alt="sidbar">
                                <div class="recent__number">
                                    <span>03</span>
                                </div>
                            </a>
                        ...
                        <div class="recent__text">
                            ...
                            <div class="recent__date">
                                <a href="/news/nepal">23 December 2023</a>
                            </div>

                            <h6><a href="/news/nepal">NBI - NEPAL Delegations Explores & Learning of Microbanking in BRI </a></h6>
                    ...
                    <li>
                        <div class="recent__img">
                            <a href="#">
                                <img src="<?= base_url('img/blog/blog_14.png');?>" alt="sidbar">
                                <div class="recent__number">
                                    <span>04</span>
                                </div>
                            </a>
